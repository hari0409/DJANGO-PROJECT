...
class AssignTime(models.Model):
    ...
    period = models.CharField(max_length=50, choices=time_slots, default='8:00 - 8:50')
...
class Attendance(models.Model):
    ...
    date = models.DateField(default='2021-06-11')
...
class StudentCourse(models.Model):
    ...
    def get_cie(self):
        ...
        for mk in marks_list:
            m.append(mk.marks1)
        cie = math.ceil((m[0]*0.3 + m[1]*0.3 + m[2]*0.4)/10)
        return cie
